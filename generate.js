...
${NAV.map(([l, h]) => `    <a href="${h}">${l}${svg('arrow')}</a>`).join('\n')}
  ...
  <div class="drawer-foot">
    ...
    <a class="btn btn-ghost btn-block" href="https://wa.me/${T.PHONE_WA}" target="_blank" rel="noopener">Message on WhatsApp</a>
  </div>
</div>`;
}
  ...
  <div class="wrap">
    <div class="foot-grid">
      <div class="foot-brand">
        ...
        <div class="socials">
          <a href="https://wa.me/${T.PHONE_WA}" target="_blank" rel="noopener" aria-label="WhatsApp"><svg viewBox="0 0 24 24">${WA_PATH}</svg></a>
        </div>
      </div>
      <div>
        <h4>Services</h4>
...
<a class="wa" href="https://wa.me/${T.PHONE_WA}" target="_blank" rel="noopener" aria-label="Message us on WhatsApp" data-track="whatsapp">
